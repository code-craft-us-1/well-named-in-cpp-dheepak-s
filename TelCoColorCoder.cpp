...
namespace TelCoColorCoder
{
    ...
    void PrintColorCodingReference() {
        std::cout << "Color Coding Reference:" << std::endl;
        for (int i = 0; i < numberOfMajorColors; ++i) {
            for (int j = 0; j < numberOfMinorColors; ++j) {
                ColorPair colorPair = GetColorFromPairNumber(i * numberOfMinorColors + j + 1);
                std::cout << "Pair Number: " << GetPairNumberFromColor((MajorColor)i, (MinorColor)j) 
